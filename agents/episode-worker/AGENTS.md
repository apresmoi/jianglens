...
- Questions are only questions asked by students, interviewers, or other speakers in the source. Do not invent reader questions, do not promote Jiang's classroom prompts or rhetorical questions, and do not treat a student correction or statement as a question just because Jiang answers it. Every included question needs the question speaker's source refs plus a concise grounded Jiang answer with answer refs. If the source has no real audience/interviewer questions, use `questions: []`.
