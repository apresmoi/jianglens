---
title: Proximity Games And Elite Overproduction
description: "How Jiang uses game theory to read foreign pressure, civil unrest, and fifth-generation conflict as surfaces of nearer elite and factional games."
---

# Proximity Games And Elite Overproduction

This concept grows out of [Game Theory](/lens/game-theory/). The parent page teaches Jiang's method for finding the real game: name the players, constraints, incentives, psychology, and actual reward. This page follows one repeated result of that method. Sometimes the visible national or geopolitical game is governed by a nearer factional game inside the actor.
...
<!-- lens-point id="game-theory-elite-overproduction-domestic-war" concept="game-theory-proximity" evidence="video:interview-gssim9xnrae@transcript:v1#seg-0010 video:interview-gssim9xnrae@transcript:v1#seg-0011 video:interview-mcjno0xrly8@transcript:v1#seg-0077 video:interview-mcjno0xrly8@transcript:v1#seg-0096 video:interview-mcjno0xrly8@transcript:v1#seg-0097 video:interview-mcjno0xrly8@transcript:v1#seg-0104 video:interview-vvj4mxqu2qk@transcript:v1#seg-0044 video:interview-vvj4mxqu2qk@transcript:v1#seg-0045 video:interview-vvj4mxqu2qk@transcript:v1#seg-0111 video:interview-7qz4kmtbvru@transcript:v1#seg-0033 video:interview-7qz4kmtbvru@transcript:v1#seg-0035 video:interview-7qz4kmtbvru@transcript:v1#seg-0036 video:interview-7qz4kmtbvru@transcript:v1#seg-0037 video:interview-80juke0blaq@transcript:v1#seg-0016 video:interview-80juke0blaq@transcript:v1#seg-0017 video:interview-80juke0blaq@transcript:v1#seg-0022 video:interview-80juke0blaq@transcript:v1#seg-0023" -->
...
This is where Game Theory neighbors but does not replace other pages. [Mass Society](/lens/mass-society-as-political-constraint/) owns population-scale administration and pacification. [Legitimacy Fiction](/lens/legitimacy-fiction/) owns savior legitimacy when personal rule becomes relief from oligarchic failure. [Bureaucracy As Institutional Death](/lens/bureaucracy-as-institutional-death/) owns office preservation and institutional self-justification. Proximity games own the player/payoff question: which elite faction benefits when public conflict becomes the visible surface?

## Spectacle And Street Mobilization
...
## The Late-January Elite-Game Recurrence

The **2026-01-26** interview returns to the same map with a sharper faction label. Jiang says Trump's ambition is to replace the old global elite with a new elite, then locates the American crisis in [two major factions fighting for supreme power: Wall Street as the old financial elite and Silicon Valley/Palantir as the new Trump-backed elite]{evidence="video:interview-80juke0blaq@transcript:v1#seg-0017"}. Minneapolis appears as the street image of that struggle: local police, ICE, and the National Guard converge at what he calls [ground zero for a new civil war]{evidence="video:interview-80juke0blaq@transcript:v1#seg-0017"}.

The same answer pushes from faction map to emergency-power logic. ICE does not make sense to him only as deportation machinery; it makes sense if it is being turned into [a new secret police loyal to Trump]{evidence="video:interview-80juke0blaq@transcript:v1#seg-0022"}. Then the civil-war payoff becomes explicit: [incite a civil war, declare an insurrection, gain emergency powers, and override elections]{evidence="video:interview-80juke0blaq@transcript:v1#seg-0023"}. Those date-specific claims need comparison with Jiang's other forecast sources before they are treated as a settled position. On this page, the point is the game-theory structure: the public violence is read as a move inside an elite replacement game.
...
- [Game Theory](/lens/game-theory/) - for the parent method: players, constraints, incentives, actual payoff, psychology, and material checks.
- [Mass Society As Political Constraint](/lens/mass-society-as-political-constraint/) - for population-scale administration, pacification, digital control, and social-management machinery.
- [Legitimacy Fiction](/lens/legitimacy-fiction/) - for savior stories and personal-rule legitimacy when oligarchic failure makes a strongman feel like relief.
- [When War Becomes A Story Instead Of A Material Test](/lens/when-war-becomes-a-story-instead-of-a-material-test/) - for the war-specific test of cost, logistics, replacement capacity, and exit.
- [Secret Society As Coordination Technology](/lens/secret-society-as-coordination-technology/) - for hidden trust networks when secrecy, oath, taboo, or shared transgression becomes the coordination layer.
