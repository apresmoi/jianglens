...
This is the atlas surface for Jiang Xueqin's Predictive History readings of Dante's *Comedy*, not a second Dante overview. Use [Dante As Poetic Access And Reception](/lens/dante-as-poetic-access-and-reception/) as the hub, because Jiang's recurring source-backed claim is that the poem works by access and reception: poetry can [enter memory, create dissonance, and become a universe inside the reader]{evidence="video:predictive-history-6m1z-v3wgok@transcript:v1#seg-0005 video:predictive-history-6m1z-v3wgok@transcript:v1#seg-0006"}, later becoming legible when experience catches up to memorized language. A left-sidebar cluster would duplicate the existing hub for now; the smaller public change is this atlas list plus outward routing. The atlas does not need Inferno, Purgatorio, Paradiso, or a general Dante page until one of those names becomes the active reusable mechanism.

Older roots and bridges:

- **2025-03-25**, [Dante's Quiet Revolution](/episodes/predictive-history-v6cdqjnrvlk/): Renaissance root; Dante's vernacular poem makes the *Comedy* accessible to common people and turns poetry, love, imagination, and free will into the spark of modernity.
- **2026-04-08**, [Dante, Virgil, and the World That Chooses Hell](/episodes/predictive-history-6m1z-v3wgok/): bridge lecture; Dante becomes the access/reception mechanism while Virgil appears as necessary guide, inner trap, and test of the world the soul keeps choosing.
- **2026-04-29**, [Hell Is the Imagination Turned Against Itself](/episodes/predictive-history-wgpdmya2bme/): bridge lecture; Hell, Lucifer, Cato, Purgatory, self-forgiveness, and non-coercive love test whether the Comedy's order is a static judgment map or a freedom problem.

Main Dante lecture sequence:

- **2026-06-15**, [Paradise As A School For Imagination And Will](/episodes/predictive-history-xug-nsld8h4/): livestream opening; Paradiso becomes a school for imagination, paradox, and freedom rather than a logic exam.
- **2026-06-17**, [Paradise Begins Where Logic Fails](/episodes/predictive-history-7ag3emdvkt0/): numbered Dante #1; Paradise cantos 1-5 train the reader away from exam logic and toward imagination, free will, fear, and forgiveness.
- **2026-06-17**, [Dante Against Obedience](/episodes/predictive-history-04ngqzyqgpw/): livestream #3; faith, hope, and love become creative participation rather than passive obedience.
- **2026-06-18**, [Faith Makes Truth Real And Hope Risks Exile](/episodes/predictive-history-dsfmyue7dkk/): treats faith as imagination that helps make truth real and hope as the wager that exile can still bear fruit.
- **2026-06-18**, [Paradise Begins Where Strategy Ends](/episodes/predictive-history-ef5b3cwpkxg/): numbered Dante #2; Paradiso routes toward receptivity, vows, non-strategic promise, and intuition beyond institutional ranking.
- **2026-06-20**, [Question Peter, Leave Beatrice, Defeat Virgil](/episodes/predictive-history-r526-wug3me/): turns memorized poetry into delayed operating software and makes questioning part of Heaven rather than a failure of faith.
- **2026-06-23**, [Hell Begins When Hope Collapses Into Competition And Fraud](/episodes/predictive-history-p82v6uac9ss/): returns to Inferno as hope-collapse, competition, elite enclosure, propaganda, and fraud.
- **2026-06-24**, [Fraud, Faction, and the Imagination That Manufactures Hell](/episodes/predictive-history-ofk53cyz-h0/): thickens late Inferno into social design, false guidance, faction, AI/alchemy, and manufactured hell.
- **2026-06-24**, [Purgatory Begins By Washing Virgil Off](/episodes/predictive-history-ssmjknuosac/): pivots from Inferno into Purgatorio by making the first work a cleansing of Virgil's language from imagination.
- **2026-06-25**, [Macbeth's Deed And Dante's Hope](/episodes/predictive-history-mdok9qaaa7q/): uses Macbeth and Purgatory to connect deed, self-forgiveness, envy, generosity, tragedy, and transformable suffering.
- **2026-06-26**, [The Tree, The Guide, And The Chosen Fire](/episodes/predictive-history-or3eow52wcc/): carries Purgatory into democratic hope, dangerous guidance, prayer for the dead, soul-shaped fields, and chosen fire.
