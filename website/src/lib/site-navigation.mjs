export const primaryNav = [
  ...
  { key: 'topics', label: 'Topics', link: '/topics/' },
...
export const docsSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Proximity Games And Elite Overproduction', slug: 'lens/proximity-games-and-elite-overproduction' },
      ...
      { label: 'Chokepoint Empire', slug: 'lens/chokepoint-empire-and-no-exit-war' },
      { label: 'No-Exit War And Escalation Ladder', slug: 'lens/no-exit-war-and-escalation-ladder' },
      { label: 'Imperial Retrenchment And Proxy Attrition', slug: 'lens/imperial-retrenchment-and-proxy-attrition' },
    ],
  },
];
