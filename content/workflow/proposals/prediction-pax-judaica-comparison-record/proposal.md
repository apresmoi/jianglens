...
Do not promote a single "Pax Judaica" ledger item, and do not create a standalone Pax Judaica public page yet.

The active family is a conditional and partly speculative sequence. Jiang repeatedly links Israel, Iran, Jerusalem, trade routes, surveillance technology, sacred geography, and future war, but the sources do not make one settled forecast:

- **2026-01-09**, `interview-acpe2tgkbje`: if Iran falls after the approaching Israel-Iran showdown, Israel becomes the Middle East nexus under Pax Judaica through technology, surveillance, transnational capital, and Levantine route control (`video:interview-acpe2tgkbje@transcript:v1#seg-0003`).
- **2026-01-09**, `interview-acpe2tgkbje`: if Iran survives, Russia, China, and Iran can build rail and corridor networks that block U.S. oceanic control (`video:interview-acpe2tgkbje@transcript:v1#seg-0068`).
- **2026-03-09**, `interview-6rtli-qwd1i`: the live-war phase model says the GCC is done, Iran survives with Hormuz leverage, Israel reaches a mid-term Greater Israel / Pax Judaica order, and the long-term Iran-Israel conflict becomes a Gog-and-Magog-style world conflict (`video:interview-6rtli-qwd1i@transcript:v1#seg-0042`, `video:interview-6rtli-qwd1i@transcript:v1#seg-0043`, `video:interview-6rtli-qwd1i@transcript:v1#seg-0044`).
...
### Core Claim Under Comparison

The family can be named:

> Jiang's Pax Judaica forecast family tests whether an Iran-war rupture could move Middle Eastern power toward a Jerusalem-centered trade, finance, technology, surveillance, and sacred-role order, while Iran's survival would preserve a Eurasian corridor alternative and later conflict pressure.
...
3. **Phase model**: immediate Gulf devastation, Iranian recovery through Hormuz leverage, mid-term Pax Judaica, and long-term Iran-Israel / global conflict (`video:interview-6rtli-qwd1i@transcript:v1#seg-0042`, `video:interview-6rtli-qwd1i@transcript:v1#seg-0043`, `video:interview-6rtli-qwd1i@transcript:v1#seg-0044`).
...
| Source | Date | Candidate | Horizon / Test | Neighboring Mechanism | Promotion Risk |
| --- | --- | --- | --- | --- | --- |
| `interview-acpe2tgkbje` | 2026-01-09 | If Iran falls, Pax Judaica emerges with Israel as Middle East nexus through technology, surveillance, capital, and Levantine routes | Conditional on Iran falling after an approaching showdown | Chokepoint for routes and Iran; Eschatology for Jerusalem; Mass Society/Platform Infrastructure for surveillance stack | Promoting "Pax Judaica will happen" without the Iran-falls condition would overstate the source |
| `interview-acpe2tgkbje` | 2026-01-09 | If Iran survives, Eurasian rail/corridor networks can block U.S. oceanic control | Counterfactual alternative to Iran falling | Chokepoint for corridor access; Game Theory for branch comparison | Treating Iran survival and Iran fall as the same forecast would make the ledger item unfalsifiable |
| `interview-6rtli-qwd1i` | 2026-03-09 | GCC collapse, Iranian recovery through Hormuz, mid-term Pax Judaica, long-term global conflict | Short/mid/long-term phase model | Chokepoint for GCC/Hormuz; Eschatology for Gog and Magog; Prediction for sequence audit | The phase model is dense and should not be folded into a single "Israel wins" claim |
...
Prediction owns this comparison because the live problem is not whether Pax Judaica is an important term. The problem is whether several dramatic, conditional, and speculative claims can remain dated, split into families, and exposed to future correction.
...
Secret Society should remain a boundary, not a default home. Use it only when the active claim is hidden coordination, public faces carrying hidden power, esoteric trust, blackmail, or cross-institutional membership. Public end-times role assignment stays with Eschatology; dated forecast audit stays with Prediction.

## Ledger Readiness

This family is not ledger-ready as one item.

The strongest first ledger candidates are probably:

1. **2026-01-09 conditional Pax Judaica if Iran falls**, because it is early and has a clear condition (`video:interview-acpe2tgkbje@transcript:v1#seg-0003`).
2. **2026-01-09 Iran-survival corridor alternative**, because it supplies the opposing branch and keeps the forecast falsifiable (`video:interview-acpe2tgkbje@transcript:v1#seg-0068`).
3. **2026-04-03 no-nuclear / Al-Aqsa / ground-troops bundle**, but only after splitting it into three predictions and testing each separately (`video:interview-kh8dvnddooq@transcript:v1#seg-0076`, `video:interview-kh8dvnddooq@transcript:v1#seg-0078`).
...
- whether each source preserves the speculation caveat when the evidence is pattern-based rather than documentary.
...
Do not let Eschatology erase Chokepoint. Jiang's sacred script matters, but route access, Gulf fragility, Hormuz leverage, oil, food, water, labor, bases, and corridors are not decorative.

Do not let Chokepoint erase Eschatology. Jiang repeatedly says the war cannot be understood only geopolitically when actors are reading sacred sequence, acceleration, and role assignment into the board.

Do not quote or summarize hostile-audit admissions as embarrassment cleanup. They are the method: speculative analysis must remain marked as speculative, even when predictions later gain provisional legitimacy.
