...
private corpus hydration separate from the agent `GH_TOKEN`. Treat that checkout
as private grounding material: use it for analysis and proposals, but do not
publish raw paid post text or raw comment threads.
